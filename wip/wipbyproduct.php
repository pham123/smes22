...
$_SESSION['wip']['ProductsId'] = $_GET['ProductsId'];
}

if(isset($_SESSION['wip']['ProductsId'])){
$sql = "SELECT * FROM `wipqty` WHERE `ProductsId` = ?";
$wipcur= $sDB->query($sql,$_SESSION['wip']['ProductsId'])->fetchAll();
}
?>
            ...
            echo "<table class='table table-bordered' id='dataTable' width='100%' cellspacing='0'>";
              ...
              foreach ($wipcur as $key => $value) {
                ...
                # code...
                  ...
                  echo "<th>".$scmstationbykey[$value['SupplyChainObjectId']]['name']."</th>";
